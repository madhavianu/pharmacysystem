...
SECRET_KEY = 'django-insecure-3#=lilcks)e+*ta1o-6261%k+sp%@b__z77yboc7!nzv%lx$$4'
...
LOGIN_URL = '/login/adminlog/'

SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Default session backend
SESSION_EXPIRE_AT_BROWSER_CLOSE = True  # Ensure session is cleared when the browser is closed
